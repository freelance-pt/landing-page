      ...
      <div>
        <div className='mb-4 md:mb-0 w-full mx-auto relative'>
          <div className='px-4 lg:px-0'>
            ...
            <a href='#' className='py-2 text-green-700 inline-flex items-center justify-center mb-2'></a>
          </div>
          <div className='relative w-full aspect-[2.39/1]'>
            <Image src={tea} alt='blog detail' layout='fill' objectFit='cover' />
          </div>
        </div>
        <div className='flex flex-col lg:flex-row lg:space-x-12'>
          <div className='px-4 lg:px-0 mt-12 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4'>
            <p className='pb-6'>
              ...
              advantages resolution son indulgence. Part sure on no long life am at ever. In songs above he as drawn to.
            ...
            <p className='pb-6'>
              ...
              excuse active had son wholly coming number add. Though all excuse ladies rather regard assure yet. If
            ...
            <div className='border-l-4 border-gray-500 pl-4 mb-6 italic rounded'>
              ...
              whence. Steepest speaking up attended it as. Made neat an on be gave show snug tore.
            </div>
            <p className='pb-6'>
              Exquisite cordially mr happiness of neglected distrusts. Boisterous impossible unaffected he me
              everything. Is fine loud deal an rent open give. Find upon and sent spot song son eyes. Do endeavor he
              differed carriage is learning my graceful. Feel plan know is he like on pure. See burst found sir met
              think hopes are marry among. Delightful remarkably new assistance saw literature mrs favourable.
            </p>
            <h2 className='text-2xl text-gray-800 font-semibold mb-4 mt-4'>
              Uneasy barton seeing remark happen his has
            </h2>
            <p className='pb-6'>
              Guest it he tears aware as. Make my no cold of need. He been past in by my hard. Warmly thrown oh he
              common future. Otherwise concealed favourite frankness on be at dashwoods defective at. Sympathize
            ...
            <p className='pb-6'>
              ...
              convinced ye. Pleasant in to although as if differed horrible. Mirth his quick its set front enjoy hoped
              had there. Who connection imprudence middletons too but increasing celebrated principles joy. Herself too
              improve gay winding ask expense are compact. New all paid few hard pure she.
            </p>
            <p className='pb-6'>
            ...
            <p className='pb-6'>
              Detract yet delight written farther his general. If in so bred at dare rose lose good. Feel and make two
              real miss use easy. Celebrated delightful an especially increasing instrument am. Indulgence contrasted
              sufficient to unpleasant in in insensible favourable. Latter remark hunted enough vulgar say man. Sitting
              hearted on it without me.
            </p>
          </div>
          <div className='w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm'>
            <h3 className='font-semibold mb-4 text-lg'>Bài viết có liên quan:</h3>
            <BlogCard className='lg:w-full px-0' />
            <BlogCard className='lg:w-full px-0' />
            <BlogCard className='lg:w-full px-0' />
          </div>
        </div>
